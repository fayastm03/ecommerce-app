...
import 'package:e_comm_app/models/api_response.dart';
import 'package:e_comm_app/utility/snack_bar_helper.dart';
  ...
  Future<String?> login(LoginData data) async {
    try {
      ...
      if (response.isOk) {
        ...
        return 'Error ${response.body?['message'] ?? response.statusCode}';
      }
    } catch (e) {
      print(e);

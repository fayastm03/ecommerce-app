...
class Chart extends StatelessWidget {
  ...
  List<PieChartSectionData> _buildPieChartSelectionData(BuildContext context) {
    ...
    int pendingOrder =
        context.dataProvider.calculateOrderWithStatus(status: 'pending');
    int processingOrder =
        context.dataProvider.calculateOrderWithStatus(status: 'processing');
    int cancelledOrder =
        context.dataProvider.calculateOrderWithStatus(status: 'cancelled');
    int shippedOrder =
        context.dataProvider.calculateOrderWithStatus(status: 'shipped');
    int deliveredOrder =
        context.dataProvider.calculateOrderWithStatus(status: 'delivered');

  ...
  Widget build(BuildContext context) {
    return Consumer<DataProvider>(
      builder: (context, dataProvider, child) {
        ...
        int pendingOrder =
            dataProvider.calculateOrderWithStatus(status: 'pending');
        int processingOrder =
            dataProvider.calculateOrderWithStatus(status: 'processing');
        int cancelledOrder =
            dataProvider.calculateOrderWithStatus(status: 'cancelled');
        int shippedOrder =
            dataProvider.calculateOrderWithStatus(status: 'shipped');
        int deliveredOrder =
            dataProvider.calculateOrderWithStatus(status: 'delivered');
        return Container(
